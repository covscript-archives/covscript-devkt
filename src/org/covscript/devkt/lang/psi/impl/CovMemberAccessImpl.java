...
import org.covscript.devkt.lang.psi.CovMemberAccess;
...
public class CovMemberAccessImpl extends CovExprImpl implements CovMemberAccess {

  public CovMemberAccessImpl(ASTNode node) {
    super(node);
  }
