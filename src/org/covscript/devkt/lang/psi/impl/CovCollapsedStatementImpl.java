...
public class CovCollapsedStatementImpl extends ASTWrapperPsiElement implements CovCollapsedStatement {

  public CovCollapsedStatementImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CovVisitor visitor) {
    visitor.visitCollapsedStatement(this);
  }
