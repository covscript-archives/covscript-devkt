...
import org.covscript.devkt.lang.psi.CovArrayLit;
...
public class CovArrayLitImpl extends CovExprImpl implements CovArrayLit {

  public CovArrayLitImpl(ASTNode node) {
    super(node);
  }
